---
name: "RPS_создание_презентаций"
description: "Создание, редактирование, проверка и экспорт презентаций RPS. Используй, когда нужно собрать или доработать слайды, PPT или PPTX для RPS на базе внутреннего PowerPoint workflow."
---

# RPS_создание_презентаций

Use this skill whenever the user asks Codex to create, generate, edit, revise, improve, render, verify, or export a RPS presentation deck, slide deck, slides, PowerPoint, PPT, or PPTX file, unless the user explicitly requests a different slide skill or tool.
