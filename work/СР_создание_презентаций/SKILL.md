---
name: "СР_создание_презентаций"
description: "Создание, редактирование, проверка и экспорт презентаций СР. Используй, когда нужно собрать или доработать слайды, PPT или PPTX для СР на базе внутреннего PowerPoint workflow."
---

# СР_создание_презентаций

Use this skill whenever the user asks Codex to create, generate, edit, revise, improve, render, verify, or export a СР presentation deck, slide deck, slides, PowerPoint, PPT, or PPTX file, unless the user explicitly requests a different slide skill or tool.
